...
function makeClient(accessType: "Custom" | "Limited Access", selections = ["basic", "chain", "chains", "chainreport", "members"]) {
  return {
    getKeyInfo: vi.fn().mockResolvedValue({ info: { selections: { faction: selections, user: ["basic"], key: ["info"] }, access: { level: 3, type: accessType, faction: true, company: false }, user: { id: 3_212_954, faction_id: 51_393, company_id: null } } }),
