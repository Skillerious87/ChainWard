...
export function PurchaseReviewGuide() {
  return <section className="admin-procedure" aria-labelledby="purchase-procedure-title">
    ...
    <ol><li><span>1</span><p><strong>Match the identities</strong><small>Confirm the Torn sender, faction ID, request ID, and exact payment reference.</small></p></li><li><span>2</span><p><strong>Verify the transfer</strong><small>Check the expected Donator Pack quantity in Torn. Chainward never claims to verify this automatically.</small></p></li><li><span>3</span><p><strong>Activate or renew</strong><small>Initial approval grants the purchaser faction-scoped administrator access. Renewals extend from the current paid-through date.</small></p></li><li><span>4</span><p><strong>Preserve the audit trail</strong><small>The reviewer, player, faction, decision, timestamp, plan, and reference are committed together.</small></p></li></ol>
  </section>;
}
